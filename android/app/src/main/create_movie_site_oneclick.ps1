# Detect current folder where script is located
$scriptFolder = Split-Path -Parent $MyInvocation.MyCommand.Definition
$projectRoot = Join-Path $scriptFolder "my-movie-site"
...
$moviesJs = @"
export const movies = [
  { id: 1, title: 'Night of the Living Dead', year: 1968, genre: 'Horror',
  ...
  { id: 2, title: 'A Trip to the Moon', year: 1902, genre: 'Sci-Fi',
...
# Run npm install and npm start automatically
Start-Process "cmd.exe" "/k cd `"$projectRoot`" && npm install && npm start"
