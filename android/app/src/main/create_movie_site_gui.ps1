...
[System.Windows.MessageBox]::Show("✅ Your legal movie site was created successfully at `"$projectRoot`"!
Run PowerShell, cd to this folder, and use `npm install` then `npm start` to launch.","Success")
